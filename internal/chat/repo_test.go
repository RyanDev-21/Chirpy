...
// 	t.Run("Testing the uuid compare",func(t *testing.T) {
// 		firstId:= uuid.New()
// 		secondID:= uuid.New()
...
// 			winnerID= secondID
// 		}
// 		getID:=GetChatKey(firstId,secondID)	
// 		if getID != winnerID{
// 			t.Fatalf("Failed to get the righ result  expected: %v, get :%v",winnerID,getID)	
// 		}	
// 	})
// }
//
